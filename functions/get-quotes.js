...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        return { statusCode: 200, body: JSON.stringify(data.quotes) }; // Devuelve el array de cotizaciones

    } catch (error) {
        return { statusCode: 500, body: JSON.stringify({ error: 'Error interno al procesar la solicitud.' }) };
    }
};
